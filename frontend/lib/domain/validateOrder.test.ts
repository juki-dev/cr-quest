...
describe('validateOrder', () => {
  ...
  it('orden completamente invertido: todos mal ubicados salvo el del medio si coincide', () => {
  ...
  it('lista más larga que la correcta: el sobrante no cuenta ni suma ni resta', () => {
