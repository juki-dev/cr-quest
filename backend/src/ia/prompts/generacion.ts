...
export const GENERATION_INSTRUCTIONS = [
  ...
  'Nunca inventes, sugieras, listes ni cambies el orden de evaluación: la secuencia correcta',
  'ya está decidida por un instructor certificado y no es parte de tu tarea.',
  'No incluyas datos de pacientes reales ni información identificable.',
